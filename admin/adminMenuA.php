              ...
              <div class="menuContainer grid">
                ...
                <div class="foodCategoryDiv">
                    <div class="heading flex">
                        ...
                        <button class="btn">
                            <a href="addFoodA.php" class="flex">Add Food <i class="uil uil-plus icon"></i></a>
                        </button>
                    </div>
                                    ...
                                    ?>
                                      ...
                                      <div class="itemInfo">
                                          ...
                                          <div class="itemBottom flex">
                                            ...
                                            <div>
                                            <a href="<?php echo SITEURL?>admin/updateFoodA.php?id=<?php echo $id?>"><i class="uil uil-edit icon"></i></a>
                
                                            <a href="<?php echo SITEURL?>admin/deleteFoodA.php?id=<?php echo $id?>"><i class="uil uil-times-circle deleteIcon icon"></i></a>
                                          </div>
                                          </div>
                                      </div>
                                    </div>
